...
var bodyPaddingTop = 64;
var bodyPaddingButtom = 64;
...
var TransitionItem = _react2.default.createClass({
  ...
  componentWillAppear: function componentWillAppear(callback) {
    ...
    var fullHeight = this.props.fullHeight;
...
var DialogInline = _react2.default.createClass({
  ...
  _positionDialog: function _positionDialog() {
    ...
    var fullHeight = _props3.fullHeight;
    ...
    var paddingTop = (clientHeight - dialogWindowHeight) / 2 - bodyPaddingTop;
    ...
    if (autoDetectWindowHeight || autoScrollBodyContent) {
      ...
      var maxDialogContentHeight = void 0;
  ...
  render: function render() {
    ...
    var fullHeight = _props4.fullHeight;
